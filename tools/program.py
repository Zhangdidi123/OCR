...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument("-c", "--config", type=str, default=r'D:\PaddleOCR-release-2.7\configs\rec\PP-OCRv4\en_PP-OCRv4_rec.yml', help="configuration file to use")
        self.add_argument(
...
def check_device(use_gpu: object, use_xpu: object = False, use_npu: object = False, use_mlu: object = False) -> object:
    """
